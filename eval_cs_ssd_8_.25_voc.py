...
#loss curves
H = pd.read_csv('results/cs_ssd_8_.25/training_log.csv')
...
plt.savefig("results/cs_ssd_8_.25/losses.png")
plt.close()
...
weights_path = 'results/cs_ssd_8_.25/best.h5'
...
plt.savefig('results/cs_ssd_8_.25/images/decoded', dpi=my_dpi)
...
#plt.grid(False)
plt.imshow(z)
plt.savefig('results/cs_ssd_8_.25/images/nogt', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_8_.25/images/gt', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_8_.25/images/recons_pred', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_8_.25/images/encoded', dpi=my_dpi)
...
for m in range(n_B):
    ...
    plt.savefig('results/cs_ssd_8_.25/images/encoded{}'.format(m))
