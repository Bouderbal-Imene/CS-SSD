...
#plt.grid(False)
plt.imshow(z)
plt.savefig('results/ssd_BN_adam_.001/images/nogt', dpi=my_dpi)
...
plt.savefig('results/ssd_BN_adam_.001/images/gt', dpi=my_dpi)
...
plt.savefig('results/ssd_BN_adam_.001/images/recons_pred', dpi=my_dpi)
