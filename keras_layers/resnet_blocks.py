...
def identity_block(input_tensor: object, kernel_size: int, filters: List[int], stage: str, block, kernel_reg: int=0.00005):
    ...
    x = BatchNormalization(axis=bn_axis, momentum=0.9, epsilon=1e-5, name=bn_name_base + '2a')(x)
    x = Activation('relu')(x)
    ...
    x = BatchNormalization(axis=bn_axis, momentum=0.9, epsilon=1e-5, name=bn_name_base + '2b')(x)
    x = Activation('relu')(x)
    ...
    x = BatchNormalization(axis=bn_axis, momentum=0.9, epsilon=1e-5, name=bn_name_base + '2c')(x)
...
def conv_block(input_tensor: object,
    ...
    shortcut = BatchNormalization(axis=bn_axis, momentum=0.9, epsilon=1e-5, name=bn_name_base + '1')(shortcut)
