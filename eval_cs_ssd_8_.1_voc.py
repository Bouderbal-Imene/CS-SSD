...
weights_path = 'results/cs_ssd_8_.1/best.h5'
...
plt.savefig('results/cs_ssd_8_.1/images/decoded', dpi=my_dpi)
...
#plt.grid(False)
plt.imshow(z)
plt.savefig('results/cs_ssd_8_.1/images/nogt', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_8_.1/images/gt', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_8_.1/images/recons_pred', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_8_.1/images/encoded', dpi=my_dpi)
"""
...
for m in range(n_B):
    ...
    plt.savefig('results/cs_ssd_8_.1/images/encoded{}'.format(m))
