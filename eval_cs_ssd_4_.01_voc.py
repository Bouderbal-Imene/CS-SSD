...
weights_path = 'results/cs_ssd_4_.01/best.h5'
...
plt.savefig('results/cs_ssd_4_.01/images/decoded', dpi=my_dpi)
...
#plt.grid(False)
plt.imshow(z)
plt.savefig('results/cs_ssd_4_.01/images/nogt', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_4_.01/images/gt', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_4_.01/images/recons_pred', dpi=my_dpi)
...
plt.savefig('results/cs_ssd_4_.01/images/encoded', dpi=my_dpi)
...
for m in range(n_B):
    ...
    plt.savefig('results/cs_ssd_4_.01/images/encoded{}'.format(m))
